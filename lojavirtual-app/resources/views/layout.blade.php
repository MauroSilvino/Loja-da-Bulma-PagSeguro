...
<head>
    ...
    <title>Loja da Bulma - Ecommerce</title>
    ...
    <script>
        ...
        $(function(){
            $(".infocompra").on('click', function(){
                ...
                $.post('{{ route("comprar_detalhes") }}', {idpedido : id}, (result) => {
...
<nav class="navbar navbar-expand-custom navbar-mainbg mb-5">
        <a class="navbar-brand navbar-logo" href="{{ route('home') }}">Loja da Bulma</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                @else
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('comprar_historico') }}">Pedidos</a>
                </li>
                <li class="nav-item">
                ...
                @endif
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ver_carrinho') }}"><i class="fa fa-shopping-cart"></i>Carrinho</a>
                </li>
            </ul>
        </div>
    </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="widget subscribe no-box">
                            <h5 class="widget-title">Loja de Bulma<span></span></h5>
                            <p>Aqui você encontra os melhores artigos nerds do Brasil!</p>
                        </div>
                    </div>
                    ...
                    <div class="widget no-box">
                        ...
                        <ul class="thumbnail-widget">
                            ...
                            <li>
                                <div class="thumb-content"><a href="{{ route('categoria') }}">Categorias</a></div> 
                            </li>
                            @if(!\Auth::user())
                            <li>
                                <div class="thumb-content"><a href="{{ route('cadastrar') }}">Cadastrar</a></div> 
                            </li>
                            <li>
                                <div class="thumb-content"><a href="{{ route('logar') }}">Login</a></div> 
                            </li>
                            @else
                            <li>
                                <div class="thumb-content"><a href="{{ route('comprar_historico') }}">Pedidos</a></div>  
                            </li>
                            <li>
                                <div class="thumb-content"><a href="{{ route('sair') }}">Logout</a></div> 
                            </li>
                            @endif
                            </ul>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <p>Copyright Loja da Bulma © 2021. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
